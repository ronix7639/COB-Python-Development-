...
root= tk.Tk()
root.title("MONTHLY EXPENSE REPORT GENERATOR")
...
#header label style
header_label=tk.Label(header_frame,text="MONTHLY EXPENSE \n REPORT GENERATOR",bg="#879a98",fg="black",font=("Helvetica",20,"bold"))
header_label.pack()
